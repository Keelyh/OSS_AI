...
def particle_filter(motions, measurements, N=500, start_pos = [45, 45, 0]): # I know it's tempting, but don't change N!
	...
	for t in range(len(motions)):
		...
		plt.grid(b=1)
		plt.axis([0, 80, 0, 80],)
		filename = str('Testing/Robot_04/Image_%02d' % t) + '.png'
...
#		0,0,0,0,0]
#
#me =   [[-1,3.75,3.75],[-1,3.75,3.75],[-1,3.75,3.75],[-1,3.75,3.75],[-1,3.75,3.75],
...
#[pos, plot_x, plot_y] = particle_filter(mo,me, 5000)
#print pos
